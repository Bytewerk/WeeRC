...
HEADERS += ./src/WeechatMessages/wbufferclosingmessage.h
HEADERS += ./src/WeechatMessages/wbufferlineaddedmessage.h
...
SOURCES += ./src/WeechatMessages/wbufferclosingmessage.cpp
SOURCES += ./src/WeechatMessages/wbufferlineaddedmessage.cpp
