...
HEADERS += ./src/weechat/wbufferlistmessage.h
...
HEADERS += ./src/weechat/wobjectmessage.h
...
SOURCES += ./src/weechat/wbufferlistmessage.cpp
...
SOURCES += ./src/weechat/wobjectmessage.cpp
